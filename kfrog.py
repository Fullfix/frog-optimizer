...
@torch.no_grad()
def batched_cg_conv_act(X, G, module: torch.nn.Conv2d, num_iters: int, eps=1e-6):
    """
...
class KFrog(torch.optim.Optimizer):
    def __init__(
            self,
        ...
        """
        K-FROG: Kronecker Fisher ROw-wise PreconditioninG (Legacy implementation).
